/**
 * scripts/seed_russian_levels.js
 *
 * Toma el archivo JSON de las 100 fichas de nivel de ruso y las indexa
 * en la colección niveles_ruso en ChromaDB Cloud.
 *
 * Uso:
 *   node scripts/seed_russian_levels.js
 */
...
const FILE_PATH = join(__dirname, '../levels/russian/levels_1_100.json');

async function main() {
  console.log('🇷🇺 Noah — Cargando fichas de nivel de ruso en ChromaDB...');
  console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
  ...
  try {
    ...
    console.error('❌ No se encontró el archivo levels_1_100.json de ruso. ¿Ya corriste el script de generación?', err.message);
    process.exit(1);
  }
  ...
  const collection = await getNivelesCollection('ruso');
  ...
  for (const level of levels) {
    ...
    ids.push(`nivel_${level.nivel}_ruso`);
  ...
  console.log('\n✅ ¡Fichas de nivel de ruso cargadas exitosamente en ChromaDB!');
  console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
}
